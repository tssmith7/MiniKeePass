...
class GroupViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let optionsButton = UIBarButtonItem(image: UIImage(named: "wrench"), style: .plain, target: self, action: #selector(optionsPressed))
        ...
        standardToolbarItems = [optionsButton, spacer, actionButton, spacer, addButton]
    ...
    func optionsPressed(_ sender: UIBarButtonItem) {
        let storyboard = UIStoryboard(name: "DatabaseOptions", bundle: nil)
